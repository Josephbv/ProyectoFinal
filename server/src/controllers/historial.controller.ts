...
export class HistorialController {
    static async getHistorial(_req: Request, res: Response) {
        try {
    ...
    static async getHistorialByMascota(req: Request, res: Response) {
        try {
    ...
    static async getHistorialById(req: Request, res: Response) {
        try {
    ...
    static async createHistorial(req: Request, res: Response) {
        try {
            const {
    ...
    static async updateHistorial(req: Request, res: Response) {
        try {
            const id_historial = parseInt(req.params.id as string);
            const {
                id_mascota, fecha, hora, tipoVisita, veterinario, motivoConsulta,
    ...
    static async deleteHistorial(req: Request, res: Response) {
        try {
            const id_historial = parseInt(req.params.id as string);
