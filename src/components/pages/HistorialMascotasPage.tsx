...
import { FileText, Plus, Search, Calendar, Eye, Edit, Trash2, Heart, User, Users, Stethoscope, Clock, ChevronLeft, ChevronRight, ChevronsLeft, ChevronsRight, ClipboardPlus, TrendingUp, Activity, Syringe, CheckCircle, XCircle, Save, Undo2 } from "lucide-react";
                ...
                <div className="space-y-5">
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <h4 className="text-sm font-black text-dark-primary truncate leading-tight tracking-tight">
                        {mascotaSeleccionada?.nombre || 'No seleccionado'}
                      </h4>
                      <p className="text-[10px] text-dark-secondary font-black tracking-tighter opacity-60">
                        {mascotaSeleccionada?.especie || 'N/A'} · {mascotaSeleccionada?.raza || 'N/A'}
                      </p>
                    </div>
                  </div>
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <h5 className="text-[11px] font-bold text-dark-primary  tracking-tighter">
                            {vetSeleccionado.nombre}
                          </h5>
                          <p className="text-[9px] text-dark-secondary font-bold  opacity-60">ID: {vetSeleccionado.cedula || 'N/A'}</p>
                        </div>
                      </div>
                    </div>
                  )}
            ...
            <div className="max-w-4xl mx-auto space-y-10">
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <h3 className="text-lg font-black text-dark-primary  tracking-widest">Categoría del Registro <span className="text-red-500">*</span></h3>
                </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <h3 className="text-lg font-black text-dark-primary  tracking-widest">Diagnóstico y Evolución <span className="text-red-500">*</span></h3>
                  </div>
                </div>
                      ...
                      <TableRow key={entrada.id_historial} className="border-dark-color hover:bg-dark-table-hover transition-colors group">
                        ...
                        <TableCell>
                          <div className="flex items-center gap-2">
                            ...
                            <span className="font-black text-dark-primary text-xs">{entrada.nombreMascota}</span>
                          </div>
                        </TableCell>
                        <TableCell>
                          <span className="text-dark-secondary text-xs font-bold tracking-tighter">{entrada.nombreCliente}</span>
                        </TableCell>
                        <TableCell>
                        ...
                        <TableCell>
                          <span className="text-dark-primary text-xs font-bold ">{entrada.veterinario || '---'}</span>
                        </TableCell>
                        <TableCell>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="flex items-center justify-between mb-8">
            ...
            <Button
              ...
              className="bg-blue-600 hover:bg-blue-500 text-white font-black  tracking-widest px-8 rounded-2xl h-12 shadow-xl shadow-blue-500/20 gap-2"
            >
                  ...
                  <div className="flex justify-between items-start mb-6">
                    <div>
                      ...
                      <h3 className="text-2xl font-black text-dark-primary  tracking-tight group-hover:text-blue-400 transition-colors">
                        {entrada.descripcion || 'Consulta Médica'}
                      </h3>
                    </div>
                    <div className="flex items-center gap-2">
