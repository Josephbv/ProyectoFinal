...
import { EmpleadosPage } from "../../empleados/pages/EmpleadosPage";
import { RolesPage } from "../../configuracion/pages/RolesPage";
...
export function DashboardLayout({ onLogout }: DashboardProps) {
