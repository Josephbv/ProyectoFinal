                  ...
                  <div className="flex flex-wrap gap-3">
                    {visitTypes.map(type => (
                      <button
                        ...
                        className={`px-5 py-3 rounded-2xl border text-xs font-black tracking-widest transition-all flex items-center justify-center gap-3 leading-none ${formData.tipoVisita.includes(type.id)
